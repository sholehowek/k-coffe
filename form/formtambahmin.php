          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                $mn = 'MN';
                $nmn = 'minuman'; 
                $qu = mysql_query("select * from minuman");
                $hitungid = mysql_num_rows($qu);
                $nid = $hitungid+1;
                      ?>
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="../config/tambahmin_proses.php">
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                           <a href="menuminuman.php" class="btn btn-primary" name="back">Back</a>
